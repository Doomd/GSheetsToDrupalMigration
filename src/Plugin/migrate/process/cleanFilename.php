...
/**
 * Creates a clean file name (just like machine name with dots).
 *
 * The clean_filename process plugin takes the source value and runs it through
 ...
 * )
 */
class CleanFilename extends ProcessPluginBase implements ContainerFactoryPluginInterface {
  ...
  /**
   * Constructs a CleanFilename plugin.
   *
